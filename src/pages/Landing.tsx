      ...
      <section id="produto" className="relative py-24 px-4 md:px-8 scroll-mt-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[900px] mx-auto text-center">
          ...
          >
            ...
            {/* Floating Tool Icons */}
            {[
              { icon: <MapPin className="h-4 w-4" />, label: 'Google Maps', color: '#34A853', x: '-left-4 md:-left-12', y: 'top-[20%]', delay: 0.4, float: '5s' },
              { icon: <MessageSquare className="h-4 w-4" />, label: 'WhatsApp', color: '#25D366', x: '-left-2 md:-left-8', y: 'bottom-[30%]', delay: 0.6, float: '6s' },
              { icon: <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.989C18.343 21.129 22 16.99 22 12c0-5.523-4.477-10-10-10z"/></svg>, label: 'Facebook', color: '#1877F2', x: '-right-4 md:-right-12', y: 'top-[15%]', delay: 0.5, float: '7s' },
              ...
              { icon: <TrendingUp className="h-4 w-4" />, label: 'Analytics', color: '#F7941D', x: 'left-[10%]', y: 'top-[5%]', delay: 0.9, float: '6.5s' },
              { icon: <Zap className="h-4 w-4" />, label: 'SDR Agent', color: '#7B2FF2', x: 'right-[10%]', y: 'bottom-[10%]', delay: 1.1, float: '7.5s' },
            ].map((item, i) => (
              <motion.div
                key={i}
                ...
                style={{ animation: `floating ${item.float} ease-in-out infinite` }}
              >
                <div
                  className="w-10 h-10 md:w-12 md:h-12 rounded-xl flex items-center justify-center backdrop-blur-xl border border-white/10 shadow-lg cursor-default group"
