...
import { ArrowRight, Star, Check, Menu, X, Sparkles, Quote, Search, MessageSquare, Bot, CalendarCheck, Home, CreditCard, Zap, BarChart3, HelpCircle, ChevronDown } from 'lucide-react';
    ...
    <div className="text-white min-h-screen overflow-x-hidden relative">
      ...
      <section className="hero-section min-h-screen relative overflow-hidden flex items-center">
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] h-[100px] z-20">
          <svg className="wave-shape wave-light-blue absolute bottom-[10px] left-0 block h-[80px] opacity-50 z-[2]" style={{ width: '200%', animation: 'waveShift 10s ease-in-out infinite' }} viewBox="0 0 1000 100" preserveAspectRatio="none">
          ...
          <svg className="wave-shape wave-white absolute bottom-0 left-0 block h-[80px] z-[3]" style={{ width: '200%', animation: 'waveShift 10s ease-in-out infinite' }} viewBox="0 0 1000 100" preserveAspectRatio="none">
