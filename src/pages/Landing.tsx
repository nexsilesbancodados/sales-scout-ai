      ...
      <footer className="relative border-t border-white/[0.05] py-12 px-4 md:px-8">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <a href="mailto:devcriador1@gmail.com" className="text-[12px] text-white/55 hover:text-white/70 transition-colors flex items-center gap-2">
            ...
            <a href="https://wa.me/5533984123591" target="_blank" rel="noopener noreferrer" className="text-[12px] text-white/55 hover:text-white/70 transition-colors flex items-center gap-2">
            ...
            <a href="https://instagram.com/Focussdev" target="_blank" rel="noopener noreferrer" className="text-[12px] text-white/55 hover:text-white/70 transition-colors flex items-center gap-2">
