...
import { ArrowRight, Star, Check, Menu, X, Sparkles, Search, MessageSquare, Bot, CalendarCheck, Home, CreditCard, Zap, BarChart3, HelpCircle, ChevronDown } from 'lucide-react';
