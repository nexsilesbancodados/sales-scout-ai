      ...
      <section id="produto" className="relative py-24 px-4 md:px-8 scroll-mt-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[900px] mx-auto text-center">
          ...
          <div className="relative mt-16 flex items-center justify-center animate-fade-in" style={{ animationDelay: '0.3s', animationFillMode: 'both' }}>
            ...
            {[
              { icon: <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>, label: 'Google Maps', color: '#34A853', x: 'left-[5%] md:left-[12%]', y: 'top-[18%]', float: '5s' },
              ...
              { icon: <TrendingUp className="h-4 w-4" />, label: 'Analytics', color: '#F7941D', x: 'left-[18%] md:left-[22%]', y: 'top-[2%]', float: '6.5s' },
